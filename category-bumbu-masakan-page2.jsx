...
import "./CategoryBumbuMasakanPage2.css";

const products = [
  {
    img: "image/BUMBU MASAKAN/KECAP BANGO 3rb.jpg",
    name: "Kecap Bango sachet",
    price: "Rp 3.000",
    stock: "Tersedia",
  },
  {
    img: "image/BUMBU MASAKAN/KETUMBAR BUBUK 125gr.jpg",
    name: "Ketumbat Bubuk 125 gr",
    price: "Rp unknown",
    stock: "Tersedia",
  },
  {
    img: "image/BUMBU MASAKAN/KOPI BUBUK 18rb.jpg",
    name: "Kopi Bubuk",
    price: "Rp 18.000",
    stock: "Tersedia",
  },
  {
    img: "image/BUMBU MASAKAN/KOPI BUBUK 666 21,5rb.jpg",
    name: "Kopi Bubuk 666",
    price: "Rp 21.500",
    stock: "Tersedia",
  },
  {
    img: "image/BUMBU MASAKAN/MASAKO AYAM 123gr.jpg",
    name: "Masako Ayam 123 gr",
    price: "Rp unknown",
    stock: "Tersedia",
  },
  {
    img: "image/BUMBU MASAKAN/MASAKO SAPI 123gr.jpg",
    name: "Masako Sapi",
    price: "Rp unknown",
    stock: "Tersedia",
  },
  {
    img: "image/BUMBU MASAKAN/MASAKO SAPI RENCENG.jpg",
    name: "Masako Sapi Renceng",
    price: "Rp unknown",
    stock: "Tersedia",
  },
  {
    img: "image/BUMBU MASAKAN/MAYONAIS MAESTRO 1kg 28rb.jpg",
    name: "Mayonais Maestro 1 kg",
    price: "Rp 28.000",
    stock: "Tersedia",
  },
];

const CategoryBumbuMasakanPage2 = () => (
  <>
    {/* Header */}
    <header>
    ...
    <section className="products-section">
      <div className="container">
        ...
        <div className="pagination">
          ...
          <a href="category-bumbu-masakan-page2.html" className="pagination-item active">2</a>
          ...
          <a href="category-bumbu-masakan-page3.html" className="pagination-item"><i className="fas fa-chevron-right"></i></a>
        </div>
      </div>
    </section>
...
export default CategoryBumbuMasakanPage2;