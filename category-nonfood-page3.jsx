...
import "./CategoryNonfoodPage3.css";

const products = [
  {
    img: "image/NON FOOD/LEM SYAITONNIROJIM.jpg",
    name: "Lem Korea",
    price: "Rp 6000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/MAMA LEMON 1,5kg 24000.jpg",
    name: "Mama Lemon 1,5kg",
    price: "Rp 24.000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/OBAT NYAMUK 4000 _kotak.jpg",
    name: "Obat Nyamuk",
    price: "Rp 4000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/PAKET NUVO ISI 4 6000.jpg",
    name: "Sabun Mandi Nuvo Paket",
    price: "Rp 6000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/PEPSODENT 120gr 10000.jpg",
    name: "Pepsodent 120gr",
    price: "Rp 10.0000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/PEPSODENT 190gr 14000.jpg",
    name: "Pepsodent 190gr",
    price: "Rp 14.000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/SABUN BTG 3000(1).jpg",
    name: "Sabun batang giv",
    price: "Rp 3000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/SABUN BTG 3000.jpg",
    ...
    <section className="products-section">
      <div className="container">
        ...
        <div className="pagination">
          ...
          <a href="category-nonfood-page3.html" className="pagination-item active">3</a>
          ...
          <a href="category-nonfood-page4.html" className="pagination-item"><i className="fas fa-chevron-right"></i></a>
        </div>
      </div>
    </section>
...
export default CategoryNonfoodPage3;