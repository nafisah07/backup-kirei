...
import "./CategoryJajananMinumanPage5.css";

const products = [
  {
    img: "image/JAJANAN & MINUMAN/ROMA KELAPA.jpg",
    name: "Roma Kelapa Cream",
    price: "Rp 13.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/ROSE CREAM.jpg",
    name: "Rose Cream",
    price: "Rp 12.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/SKM SASET COKLAT.jpg",
    name: "Susu Saset Coklat",
    price: "Rp 2.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/TEH MANIS BONTEH.jpg",
    name: "Teh Manis Bonteh",
    price: "Rp 3.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/TEH PUCUK HARUM.jpg",
    name: "Teh Pucuk",
    price: "Rp 3.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/TEH SARIWANGI SASET.jpg",
    name: "Teh Sariwangi",
    price: "Rp 1.500",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/TOP GULA AREN.jpg",
    name: "Top Gula Aren",
    price: "Rp 2.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/TORA MOKA.jpg",
    name: "Tora Moka",
    price: "Rp 2.000",
    stock: "Tersedia",
  },
...
const CategoryJajananMinumanPage5 = () => (
  <>
    {/* Header */}
    <header>
    ...
    <section className="products-section">
      <div className="container">
        ...
        <div className="pagination">
          ...
          <a href="category-jajanan-minuman-page5.html" className="pagination-item active">5</a>
        </div>
      </div>
    </section>
...
export default CategoryJajananMinumanPage5;