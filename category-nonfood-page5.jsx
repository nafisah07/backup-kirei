...
import "./CategoryNonfoodPage5.css";

const products = [
  {
    img: "image/NON FOOD/SABUT JARING 5000.jpg",
    name: "Sabut Jaring",
    price: "Rp 5.000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/SABUT STAINLESS 3000.jpg",
    name: "Sabun Stainless",
    price: "Rp 3.000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/SHAMPOO SASET CLEAR OREN.jpg",
    name: "Shampo Saset Clear Oren",
    price: "Rp 1.000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/SHAMPOO SASET CLEAR.jpg",
    name: "Shampo Saset Clear",
    price: "Rp 1.000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/SHAMPOO SASET HEAD&SHOULDERS.jpg",
    name: "Shampo Saset HeadShoulder",
    price: "Rp 1.000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/SHAMPOO SASET LIFEBUOY_.jpg",
    name: "Shampo Saset Lifeboy",
    price: "Rp 5.000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/SHAMPOO SASET PANTENE AVOCADO.jpg",
    name: "Shampo Saset Pantene Avodado",
    price: "Rp 1.000",
    stock: "Tersedia",
  },
  {
    img: "image/NON FOOD/SHAMPOO SASET PANTENE HIJAU.jpg",
    name: "Shampo Saset",
    price: "Rp 1.000",
    stock: "Tersedia",
  },
    ...
    <section className="products-section">
      <div className="container">
        ...
        <div className="pagination">
          ...
          <a href="category-nonfood-page5.html" className="pagination-item active">5</a>
          <a href="category-nonfood-page6.html" className="pagination-item">6</a>
          <a href="category-nonfood-page6.html" className="pagination-item"><i className="fas fa-chevron-right"></i></a>
        </div>
      </div>
    </section>
...
export default CategoryNonfoodPage5;