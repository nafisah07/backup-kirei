...
import "./CategoryJajananMinumanPage4.css";

const products = [
  {
    img: "image/JAJANAN & MINUMAN/MIZONE CRANBERRY & LYCHEE LEMON.jpg",
    name: "Mizone Cranberry & Lychee Lemon",
    price: "Rp 7.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/PEANUT BISCUIT.jpg",
    name: "Peanut Biskuit",
    price: "Rp 15.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/POP ICE CAPPUCINO.jpg",
    name: "Pop Ice Cappucino",
    price: "Rp 2.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/POP ICE CHOCOCREAM.jpg",
    name: "Pop Ice Chococream",
    price: "Rp 2.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/POP ICE PERMEN KARET.jpg",
    name: "Pop Ice Permen Karet",
    price: "Rp 2.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/POP ICE STOBERI.jpg",
    name: "Pop Ice Stroberi",
    price: "Rp 2.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/POP ICE TARO.jpg",
    name: "Pop Ice Taro",
    price: "Rp 2.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/POWER F.jpg",
    name: "Power F",
    price: "Rp 2.000",
    stock: "Tersedia",
  },
...
const CategoryJajananMinumanPage4 = () => (
  <>
    {/* Header */}
    <header>
        ...
        <ul>
          ...
          <li className="dropdown">
            ...
            <div className="dropdown-content">
              ...
              <a href="category-jajanan-minuman.html" className="active">Jajanan dan Minuman</a>
    ...
    <section className="category-hero">
      <div className="container">
        ...
        <p>
          Aneka snack, biskuit, minuman kemasan, kopi, teh, dan minuman segar untuk menemani hari-hari Anda
        </p>
      </div>
    </section>
    ...
    <section className="products-section">
      <div className="container">
        ...
        <div className="pagination">
          <a href="category-jajanan-minuman.html" className="pagination-item">1</a>
          <a href="category-jajanan-minuman-page2.html" className="pagination-item">2</a>
          <a href="category-jajanan-minuman-page3.html" className="pagination-item">3</a>
          <a href="category-jajanan-minuman-page4.html" className="pagination-item active">4</a>
          <a href="category-jajanan-minuman-page5.html" className="pagination-item">5</a>
          <a href="category-jajanan-minuman-page5.html" className="pagination-item"><i className="fas fa-chevron-right"></i></a>
        </div>
      </div>
    </section>
...
export default CategoryJajananMinumanPage4;