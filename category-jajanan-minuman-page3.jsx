...
import "./CategoryJajananMinumanPage2.css";

const products = [
  {
    img: "image/JAJANAN & MINUMAN/ENERGEN COKLAT.jpg",
    name: "Energen Coklat",
    price: "Rp 3.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/ENERGEN KACANG HIJAU.jpg",
    name: "Energen Kacang Hijau",
    price: "Rp 3.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/ENERGEN VANILA.jpg",
    name: "Energen Vanilla",
    price: "Rp 3.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/FLORIDINA.jpg",
    name: "Floridina",
    price: "Rp 4.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/GABIN HATARI MALKIST.jpg",
    name: "Gabin Hatari Malkist",
    price: "Rp 9.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/GABIN HATARI PLAIN.jpg",
    name: "Gabin Hatari Plain",
    price: "Rp 9.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/GALON AQUA.jpg",
    name: "Galon AQUA",
    price: "Rp 50.000",
    stock: "Tersedia",
  },
  {
    img: "image/JAJANAN & MINUMAN/GALON VIT.jpg",
    name: "Galon VIT",
    price: "Rp 50.000",
    stock: "Tersedia",
  },
...
const CategoryJajananMinumanPage2 = () => (
  <>
    {/* Header */}
    <header>
    ...
    <section className="products-section">
      <div className="container">
        ...
        <div className="pagination">
          ...
          <a href="category-jajanan-minuman-page2.html" className="pagination-item active">2</a>
          <a href="category-jajanan-minuman-page3.html" className="pagination-item">3</a>
          <a href="category-jajanan-minuman-page4.html" className="pagination-item">4</a>
          <a href="category-jajanan-minuman-page5.html" className="pagination-item">5</a>
          <a href="category-jajanan-minuman-page3.html" className="pagination-item"><i className="fas fa-chevron-right"></i></a>
        </div>
      </div>
    </section>
...
export default CategoryJajananMinumanPage2;