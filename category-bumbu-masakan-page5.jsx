...
import "./CategoryBumbuMasakanPage5.css";

const products = [
  {
    img: "image/BUMBU MASAKAN/TEPUNG KOBE KENTUCKY.jpg",
    name: "Tepung Kobe Kentucky",
    price: "Rp unknown",
    stock: "Tersedia",
  },
  {
    img: "image/BUMBU MASAKAN/TEPUNG SAJIKU.jpg",
    name: "Tepung Sajiku",
    price: "Rp unknown",
    stock: "Tersedia",
  },
  {
    img: "image/BUMBU MASAKAN/TERASI.jpg",
    name: "Terasi",
    price: "unknown",
    stock: "Tersedia",
  },
...
const CategoryBumbuMasakanPage5 = () => (
  <>
    {/* Header */}
    <header>
    ...
    <section className="products-section">
      <div className="container">
        ...
        <div className="pagination">
          ...
          <a href="category-bumbu-masakan-page5.html" className="pagination-item active">5</a>
...
export default CategoryBumbuMasakanPage5;